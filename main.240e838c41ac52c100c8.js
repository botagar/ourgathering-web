...
`,Z=(0,h.ZP)(o.rU)`
  display: flex;
  width: 85px;
`,S=r.p+"fonts/Montserrat-VariableFont_wght-3faa3eef13649db02044.ttf";var O=r(532);const E=()=>(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(O.AG,{}),(0,i.jsx)(Q,{})]}),T=h.iv`
    @font-face {
...
`,M=r.p+"images/earth-f8859dc6b5e803b15b90.png",D=r.p+"images/laptop-e93f1f319eec1b956fb0.png",C=({data:e})=>(0,i.jsxs)(z,{children:[(0,i.jsx)(V,{children:e.name}),(0,i.jsx)("p",{children:e.date.toLocaleDateString()}),(0,i.jsx)(F,{children:e.description}),(0,i.jsxs)(q,{children:[0===e.locations.length&&(0,i.jsx)(H,{}),e.locations.length<=4&&e.locations.map((e=>{const{name:t,type:r,address:n}=e;return(0,i.jsx)(U,{name:t,type:r,address:n},`${r}/${t}`)})),e.locations.length>4&&(0,i.jsxs)(i.Fragment,{children:[e.locations.slice(0,3).map((e=>{const{name:t,type:r,address:n}=e;return(0,i.jsx)(U,{name:t,type:r,address:n},`${r}/${t}`)})),(0,i.jsx)(N,{remainder:e.locations.length-3})]})]})]}),U=({name:e,type:t,address:r})=>(0,i.jsxs)(J,{children:[(0,i.jsxs)(K,{children:[(0,i.jsx)(W,{src:"TERRESTRIAL"===t?M:D}),(0,i.jsx)("p",{children:e})]}),(0,i.jsx)(Y,{children:r})]}),N=({remainder:e})=>(0,i.jsx)(X,{children:(0,i.jsxs)("p",{children:["+ ",e," More Locations"]})}),H=()=>{const{t:e}=(0,v.$G)();return(0,i.jsx)(ee,{children:(0,i.jsx)("p",{children:e("manage:no_location")})})},z=h.ZP.div`
  display: flex;
  flex-direction: column;
